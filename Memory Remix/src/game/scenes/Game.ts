...
export class Game extends Scene {
  ...
  updateScore() {
    ...
    if (this.playerCount === 2) {
      if (this.playerTurn === 1) {
        ...
        this.player1Score.setText("P1 Matched: " + this.player1CardCount);
      } else {
        console.log("P2 UPDATED");
        this.player2CardCount++;
        this.player2Score.setText("P2 Matched: " + this.player2CardCount);
      }
    } else {
  ...
  getCardsPosition(): {
    ...
    const maxGridWidth = this.scale.width * this.configSetting.widthMultiplier;
    const maxGridHeight =
    ...
    const rawGridHeight =
      this.configSetting.rows * texH + (this.configSetting.rows - 1) * marginY;
  ...
  create() {
    ...
    if (this.playerCount === 1) {
      ...
      this.player1Score = this.add
        .text(
          this.scale.width / 2,
          this.isMobile ? this.scale.height - 75 : this.scale.height - 100,
          "Matched: " + 0,
          {
      ...
      this.player2Score = this.add
        .text(
          this.isMobile ? this.scale.width - 75 : this.scale.width - 200,
          this.isMobile ? 90 : 50,
          "P2 Matched: " + 0,
          {
            fontFamily: "Share Tech Mono",
